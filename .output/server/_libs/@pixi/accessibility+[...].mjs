...
var Ticker = function() {
	...
	*/
	Ticker.prototype._requestIfNeeded = function() {
		if (this._requestId === null && this._head.next) {
			this.lastTime = performance_default.now();
	...
	*/
	Ticker.prototype.update = function(currentTime) {
		if (currentTime === void 0) currentTime = performance_default.now();
		var elapsedMS;
...
var AccessibilityManager = function() {
	...
	*/
	AccessibilityManager.prototype.update = function() {
		var now = performance_default.now();
...
//#endregion
export { SVGResource as $, deprecation as $t, Framebuffer as A, MSAA_QUALITY as An, Ticker as At, ImageResource as B, ObservablePoint as Bt, BufferResource as C, COLOR_MASK_BITS as Cn, generateProgram as Ct, Filter as D, GC_MODES as Dn, resources as Dt, CubeResource as E, FORMATS as En, getUBOData as Et, Geometry as F, TARGETS as Fn, extensions as Ft, ProjectionSystem as G, Rectangle as Gt, MaskSystem as H, Point as Ht, GeometrySystem as I, TYPES as In, Circle as It, RenderTexture as J, Transform as Jt, Quad as K, RoundedRectangle as Kt, IGLUniformData as L, WRAP_MODES as Ln, DEG_TO_RAD as Lt, GLFramebuffer as M, RENDERER_TYPE as Mn, UPDATE_PRIORITY as Mt, GLProgram as N, SAMPLER_TYPES as Nn, Runner as Nt, FilterState as O, MASK_TYPES as On, systems as Ot, GLTexture as P, SCALE_MODES as Pn, ExtensionType as Pt, Resource as Q, createIndicesForQuads as Qt, INSTALLED as R, performance_default as Rn, Ellipse as Rt, Buffer as S, CLEAR_MODES as Sn, defaultVertex$1 as St, ContextSystem as T, ENV as Tn, getTestContext as Tt, ObjectRenderer as U, Polygon as Ut, MaskData as V, PI_2 as Vt, Program as W, RAD_TO_DEG as Wt, RenderTextureSystem as X, CanvasRenderTarget as Xt, RenderTexturePool as Y, groupD8 as Yt, Renderer as Z, correctBlendMode as Zt, BatchPluginFactory as _, settings as _n, autoDetectRenderer as _t, DisplayObject as a, premultiplyRgba as an, StateSystem as at, BatchSystem as b, BUFFER_BITS as bn, createUBOElements as bt, AbstractMultiResource as c, removeItems as cn, Texture as ct, Attribute as d, trimCanvas as dn, TextureSystem as dt, getResolutionOfUrl as en, ScissorSystem as et, BaseImageResource as f, uid as fn, TextureUvs as ft, BatchGeometry as g, isMobile as gn, ViewableBuffer as gt, BatchDrawCall as h, BrowserAdapter as hn, VideoResource as ht, Container as i, import_eventemitter3 as in, State as it, FramebufferSystem as j, PRECISION as jn, TickerPlugin as jt, FilterSystem as k, MIPMAP_MODES as kn, uniformParsers as kt, AbstractRenderer as l, sign as ln, TextureGCSystem as lt, BaseTexture as m, utils_exports as mn, VERSION as mt, accessibleTarget as n, hex2string as nn, ShaderSystem as nt, TemporaryDisplayObject as o, premultiplyTint as on, StencilSystem as ot, BaseRenderTexture as p, url as pn, UniformGroup as pt, QuadUv as q, SHAPES as qt, Bounds as r, import_earcut as rn, SpriteMaskFilter as rt, AbstractBatchRenderer as s, premultiplyTintToRgba as sn, System as st, AccessibilityManager as t, hex2rgb as tn, Shader as tt, ArrayResource as u, string2hex as un, TextureMatrix as ut, BatchRenderer as v, ALPHA_MODES as vn, autoDetectResource as vt, CanvasResource as w, DRAW_MODES as wn, generateUniformBufferSync as wt, BatchTextureArray as x, BUFFER_TYPE as xn, defaultFilterVertex as xt, BatchShaderGenerator as y, BLEND_MODES as yn, checkMaxIfStatementsInShader as yt, ImageBitmapResource as z, Matrix as zt };
